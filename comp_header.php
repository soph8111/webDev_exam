...
<body>
    <header>
        ...
        <div>
            ...
            ?>
            <?php if($lang == "dk") { echo '<a href="/?lang=en">🇬🇧 English</a>';}?>
    ...
    <div id="menu">
        ...
        <nav>
            ...
            <div id="link">
                ...
                <a href=<?='things_to_do.php?lang='.$lang?>>
